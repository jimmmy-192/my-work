    ...
    >
      ...
      >
        ...
        {appDefinitions.filter((app) => app.dock && app.id !== "trash").map((app) => {
          ...
          return (
            <button
              className={`dock-app dock-magnify-item${app.id === "work" ? " dock-app--works" : ""}${app.id === "about" ? " dock-app--character" : ""}${app.id === "contact" ? " dock-app--contact" : ""}${active ? " is-active" : ""}`}
              ...
              onClick={() => openApp(app.id)}
            >
              <span className={app.id === "work" || app.id === "about" || app.id === "contact" ? "dock-default-icon" : undefined} aria-hidden="true">
