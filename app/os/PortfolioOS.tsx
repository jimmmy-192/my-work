    ...
    >
      ...
      >
        ...
        {appDefinitions.filter((app) => app.dock && app.id !== "trash").map((app) => {
          ...
          return (
            <button
              className={`dock-app dock-magnify-item${app.id === "welcome" ? " dock-app--welcome" : ""}${app.id === "work" ? " dock-app--works" : ""}${app.id === "about" ? " dock-app--character" : ""}${app.id === "contact" ? " dock-app--contact" : ""}${active ? " is-active" : ""}`}
              ...
              onClick={() => openApp(app.id)}
            >
              <span className={app.id === "welcome" || app.id === "work" || app.id === "about" || app.id === "contact" ? "dock-default-icon" : undefined} aria-hidden="true">
                <AppIcon appId={app.id} size={24} />
              </span>
              {app.id === "welcome" ? (
                <span className="dock-welcome-art" aria-hidden="true" />
              ) : null}
              {app.id === "work" ? (
                <span className="dock-works-art" aria-hidden="true" />
              ) : null}
              {app.id === "about" ? (
